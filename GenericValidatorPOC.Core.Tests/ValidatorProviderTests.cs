...
namespace GenericValidatorPOC.Core.Tests {
  public class ValidatorProviderTests {
    ...
    public void ValidatorProviderShouldHaveHostInitializerRegisteredValidators() =>
      Assert.IsTrue(ValidatorProvider.Instance
                                     .HasValidatorOf<MockHostInitializerRegisteredModel>());
    ...
    public void ValidatorProviderShouldBeAbleToCreateValidatorsWithATypeSafeApi() =>
      Assert.Throws<InvalidMockHostInitializerRegisteredModelMessageError>(() => {
        var validator = ValidatorProvider.Instance
                                         .CreateValidatorOf<MockHostInitializerRegisteredModel>();
    ...
    public void ValidatorProviderShouldBeAbleToCreateValidatorsWithArguments() {
      ...
      var validator =
        ValidatorProvider.Instance.Create<AttributeRegisteredModelValidator>(expectedTag);
    ...
    public void ValidatorProviderShouldThrowWithInvalidUseOfTheCastApi() {
      Assert.Throws<InvalidCastException>(() => {
        var validator = ValidatorProvider.Instance
                                         .CreateValidatorInstanceOfAs<
                                            MockHostInitializerRegisteredModel,
                                            AttributeRegisteredModelValidator>();
      });
    }
